        ...
        <div className="container relative z-10">
          <div className="max-w-3xl mx-auto text-center">
            <h1 className="text-5xl lg:text-7xl font-bold mb-6">
              Case <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary-400 to-accent-500">Studies</span>
            </h1>
            <p className="text-xl text-white/70 leading-relaxed">
              Real work. Real results. Explore how we've helped companies achieve their digital goals.
            </p>
          </div>
        </div>
